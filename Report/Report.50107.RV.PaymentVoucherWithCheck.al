report 50107 "RV Payment Voucher With Check"
{
    ApplicationArea = All;
    Caption = 'RV Payment Voucher With Check';
    UsageCategory = ReportsAndAnalysis;
    Permissions = TableData "Bank Account" = m;
    DefaultLayout = RDLC;
    RDLCLayout = '.\ReportLayout\RV_PaymentVoucherCheck.rdlc';
    ...
    dataset
    {
        ...
        dataitem(GenJnlLine; "Gen. Journal Line")
        {
            ...
            begin
                ...
                FormatNoText(DescriptionLine, Round("Amount (LCY)", 0.01), "Currency Code");
