/// <summary>
/// Codeunit RIKE BOM Permission Check (ID 50601)
/// FDD014 2026/02/23: New. (Stephen)
/// </summary>
codeunit 50600 "RIKE Check BOM Access "
{
    /// <summary>
    /// FDD014 
    ...
    begin
        ...
        if BOMHeader.Get(ProductionBOMNo) then
            if BOMHeader."RIKE Highly Restricted BOM" then
                if not UserSetup."RIKE Acc Highly Restricted BOM" then
