/// <summary>
/// Table RIKE QC Header (ID 50505)
/// FDD039 2026/02/23: New. (Mike)
/// </summary>
table 50505 "RIKE QC Header"
{
    Caption = 'QC Header';
    ...
    fields
    {
        ...
        field(3; "Ref. Order Type"; Enum "RIKE Ref. Order Type")
        {
        ...
        field(8; "QC Standard Type"; Enum "RIKE QC Standard Type")
        {
            Caption = 'QC Standard Type';
        }

        field(9; "QC Status"; Enum "RIKE QC Status")
        {
            Caption = 'QC Status';
        }
