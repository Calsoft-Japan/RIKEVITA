/// <summary>
/// Table RV QC Iny. Result Line (ID 50507)
/// FDD039 2026/02/23: New. (Mike)
/// </summary>
table 50507 "RV QC Iny. Result Line"
{
    ...
    fields
    {
        ...
        field(4; "Inventory Type"; Enum "RV Inventory Type")
        {
        ...
        field(6; "Classification"; Enum "RV QC Standard Type")
        {
