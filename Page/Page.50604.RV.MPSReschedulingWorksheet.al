...
page 50604 "RV MPS Rescheduling Worksheet"
{
        ...
        area(Processing)
        {
            action(CollectMPSData)
            {
                ...
                begin
                    ...
                    if not MPSReschedulingLine.IsEmpty() then
                        if not Confirm(ConfirmDeleteMsg) then
                            exit;
    ...
    var
        ...
        ConfirmDeleteMsg: Label 'There is existing MPS Rescheduling data for this batch. Do you want to delete it and collect new data?';
