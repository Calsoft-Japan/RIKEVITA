...
tableextension 50600 "RIKE User Setup" extends "User Setup"
{
    fields
    {
        ...
        field(50100; "Allow Edit of Container No."; Enum RV_EditPermission)
        {
            Caption = 'Allow Edit of Container No.';
            Description = 'FDD008';
        }
        field(50101; "Allow Edit of B/L Date"; Enum RV_EditPermission)
        {
            Caption = 'Allow Edit of B/L Date';
            Description = 'FDD008';
        }
        field(50102; "Allow Edit of Closing Date"; Enum RV_EditPermission)
        {
            Caption = 'Allow Edit of Closing Date';
            Description = 'FDD008';
        }
        field(50103; "Allow Edit of Staffing Date"; Enum RV_EditPermission)
        {
