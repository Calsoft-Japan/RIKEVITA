/// <summary>
/// TableExtension RV Sales Invoice Header (ID 50209) extends Sales Invoice Header table
/// FDD021 2026/05/06: New. (Bobby.ji)
/// </summary>
tableextension 50209 "RV Sales Invoice Header" extends "Sales Invoice Header"
{
    fields
    {
        field(50200; "RV_ETD"; Date)
        {
            Caption = 'RV ETD';
            Description = 'FDD021';
        }
